...
const BackgroundCommands = {
  ...
  tab0(request) { return selectTabIndex(0, request); },
  tab1(request) { return selectTabIndex(1, request); },
  tab2(request) { return selectTabIndex(2, request); },
  tab3(request) { return selectTabIndex(3, request); },
  tab4(request) { return selectTabIndex(4, request); },
  tab5(request) { return selectTabIndex(5, request); },
  tab6(request) { return selectTabIndex(6, request); },
  tab7(request) { return selectTabIndex(7, request); },
  tab8(request) { return selectTabIndex(8, request); },
  tab9(request) { return selectTabIndex(9, request); },
...
var selectTabIndex = (index, {count, tab}) => chrome.tabs.query({ currentWindow: true }, function(tabs) {
    if (1 < tabs.length) {
